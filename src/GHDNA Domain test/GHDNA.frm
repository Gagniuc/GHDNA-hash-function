...
Begin VB.Form Form1 
   ...
   Begin VB.Frame Frame6 
      Caption         =   "No. collision / DNA sequence length"
      Height          =   4935
      Left            =   9000
      TabIndex        =   27
      Top             =   6480
   ...
   Begin VB.Frame Frame3 
      Caption         =   "Y = GHDNA domain range from 0 to 10^14 and X = DNA length"
      Height          =   6255
      Left            =   4200
      TabIndex        =   5
      Top             =   120
...
back_in:
        ...
        If CO.Value = 1 Then
            out_seq = out_seq & " length  " & u & " b " & vbCrLf & vbCrLf & vbCrLf & vbCrLf & vbCrLf
        End If
